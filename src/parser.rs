...
impl<'src> Parser<'src> {
    ...
    pub fn parse_program(&mut self) -> Vec<Object<'src>> {
        let mut objs = vec![];
    ...
    fn parse_struct(&mut self) -> Object<'src> {
        todo!()
    }

    fn parse_global(&mut self) -> Object<'src> {
    ...
    // Pratt parsing!
    fn _parse_expr(&mut self, min_power: f32) -> Expr<'src> {
